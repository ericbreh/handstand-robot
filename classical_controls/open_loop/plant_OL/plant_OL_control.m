function [u, y, dy] = plant_OL_control(x, params)

y = y_hp_auto(x, params.th_des);
dy = Lfy_hp_auto(x, params.th_des);
...
u = LgLfy_hp_auto(x, params.th_des)\(-L2fy_hp_auto(x, params.th_des) + v);
